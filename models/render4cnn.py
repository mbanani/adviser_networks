...
class render4cnn(nn.Module):
    def __init__(self, finetune=False, weights = None, weights_path = None, num_classes = 12):
        ...
        if weights != None:
            ...
            if num_classes == 3 and ( weights['model_state_dict']['azim.0.weight'].size()[0] > 360*3):
                azim.weight.data.copy_( torch.cat([  weights['model_state_dict']['azim.0.weight'][360*4:360*5, :],  weights['model_state_dict']['azim.0.weight'][360*5:360*6, :], weights['model_state_dict']['azim.0.weight'][360*8:360*9, :] ], dim = 0) )
                elev.weight.data.copy_( torch.cat([  weights['model_state_dict']['elev.0.weight'][360*4:360*5, :],  weights['model_state_dict']['elev.0.weight'][360*5:360*6, :], weights['model_state_dict']['elev.0.weight'][360*8:360*9, :] ], dim = 0) )
                tilt.weight.data.copy_( torch.cat([  weights['model_state_dict']['tilt.0.weight'][360*4:360*5, :],  weights['model_state_dict']['tilt.0.weight'][360*5:360*6, :], weights['model_state_dict']['tilt.0.weight'][360*8:360*9, :] ], dim = 0) )

                azim.bias.data.copy_(   torch.cat([  weights['model_state_dict']['azim.0.bias'][360*4:360*5], weights['model_state_dict']['azim.0.bias'][360*5:360*6], weights['model_state_dict']['azim.0.bias'][360*8:360*9] ], dim = 0) )
                elev.bias.data.copy_(   torch.cat([  weights['model_state_dict']['elev.0.bias'][360*4:360*5], weights['model_state_dict']['elev.0.bias'][360*5:360*6], weights['model_state_dict']['elev.0.bias'][360*8:360*9] ], dim = 0) )
                tilt.bias.data.copy_(   torch.cat([  weights['model_state_dict']['tilt.0.bias'][360*4:360*5], weights['model_state_dict']['tilt.0.bias'][360*5:360*6], weights['model_state_dict']['tilt.0.bias'][360*8:360*9] ], dim = 0) )
